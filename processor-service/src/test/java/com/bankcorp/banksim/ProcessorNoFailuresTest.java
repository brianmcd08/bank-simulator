...
/**
 * Starts the real service on a random port and sends the 8 sample messages over HTTP. 3 have an invalid bank. Each
...
class ProcessorNoFailuresTest {
    ...
    void resendGets200AndIsNotProcessedAgain() throws Exception {
        ...
        ProcessorTestSupport.awaitAuditEntries(auditLog, 9);
